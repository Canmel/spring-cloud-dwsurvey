...
public class LogAspect {
    ...
    public Object doAfterAdvice(ProceedingJoinPoint joinPoint, Log log) throws Throwable {
        ...
        SysUser sysUser = (SysUser) SerizlizeUtil.unserizlize(cu);
        SysLog sysLog = new SysLog(sysUser.getUid(), sysUser.getUsername(), log.option(), time, joinPoint.getArgs().toString(), joinPoint.getSignature().toShortString(), joinPoint.getArgs().toString(), log.moduleName());
